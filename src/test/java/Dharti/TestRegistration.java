...
public class TestRegistration extends BeforeAfter{//class begin
    @Test
    public void testRegistration(){//test method begin
...
driver.findElement(By.name("submit")).click();
       ...
       //assertTrue(driver.findElement(By.tagName("Dear asquared asquared,")).isDisplayed());
...
//assertEquals("REGISTER image",driver.getTitle());
        //click SIGN-OFF
